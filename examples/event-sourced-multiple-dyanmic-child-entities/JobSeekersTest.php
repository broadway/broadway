 ...
 */
class JobSeekersCommandHandlerTest extends MicroModule\Broadway\CommandHandling\Testing\CommandHandlerScenarioTestCase
{
    private $generator;
    ...
    protected function createCommandHandler(MicroModule\Broadway\EventStore\EventStore $eventStore, Broadway\EventHandling\EventBus $eventBus): CommandHandler
    {
